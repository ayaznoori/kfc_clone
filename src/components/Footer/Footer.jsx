          ...
          <div className="big">
            ...
            <div className="boxFooterIn">
              <div>
                ...
                <a href="##">
                  {" "}
                  <h5 className="hFooter">Menu</h5>
                </a>
                <a href="##">
                  <h5 className="hFooter">Order Lookup</h5>
                </a>
                <a href="##">
                  <h5 className="hFooter">Gift Card</h5>
                </a>
              </div>
            </div>
            <div className="boxFooterIn">
              ...
              <div>
                ...
                <a href="https://online.kfc.co.in/help">
                  <h5 className="hFooter">Get Help</h5>
                </a>
                <a href="##">
                  {" "}
                  <h5 className="hFooter">Contact Us</h5>
                </a>
                <a href="##">
                  {" "}
                  <h5 className="hFooter">KFC Feedback</h5>
                </a>
              </div>
            </div>
            <div className="boxFooterIn">
              ...
              <div>
                ...
                <a href="##">
                  <h5 className="hFooter">Privacy Policy</h5>
                </a>
                <a href="##">
                  <h5 className="hFooter">Disclaimers</h5>
                </a>
                <a href="##">
                  <h5 className="hFooter">Caution Notice</h5>
                </a>
              </div>
            </div>
            <div className="boxFooterIn">
              ...
              <div>
                ...
                <a href="##">
                  {" "}
                  <h5 className="hFooter">About KFC</h5>
                </a>
                <a href="##">
                  {" "}
                  <h5 className="hFooter">KFC Care</h5>
                </a>
                <a href="##">
                  {" "}
                  <h5 className="hFooter">Careers</h5>
                </a>
                <a href="##">
                  {" "}
                  <h5 className="hFooter">Our Golden Past </h5>
                </a>
              </div>
            </div>
            <div className="boxFooterIn">
            ...
            <div className="boxFooterIn">
              ...
              >
                <img
                  className="img1"
                  src="https://i.ibb.co/4NbzRwP/512x512.png"
                  alt=""
                />
              </a>
            </div>
            ...
            <div className="boxFooterIn">
              ...
              >
                <img
                  className="img1"
                  src="https://i.ibb.co/1d8JXvr/512x512.png"
                  alt=""
                />
              </a>
            </div>

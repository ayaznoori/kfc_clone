    ...
    <div className={styles.navContainer}>
      <div className={styles.box1}>
        ...
        <div className={styles.box2}>
          ...
          <img src="https://images.ctfassets.net/wtodlh47qxpt/6bJdGLRkksNvWP4LI9ZiFF/cb89d6393492fd093e0f99980abfa39e/Account_Icon.svg"style={{ marginRight:"10px", fontSize: '20px'}} alt=""/>

 ...
 const ToastExample=() =>toast({
  ...
  return <div className={style.container}>
    ...
    <div className={style.left}>
     <img src='https://online.kfc.co.in/static/media/Stripes_Small_OffersIcon.87fc6256.svg' alt="Red Bars" width="60px"/>
     <div className={style.menuheading}>KFC MENU</div>
     <div className={style.listheading}>
        <Link to="#CHICKEN_BUCKETS" smooth>CHICKEN BUCKETS</Link>
        <Link to="#NEW_LAUNCH"> NEW LAUNCH</Link>
         <Link to="#CHICKEN_ROLLS" smooth>CHICKEN ROLLS</Link>
         <Link to="#BIRYANI_BUCKETS" smooth >BIRYANI BUCKETS</Link>
          <Link to="#BOX_MEALS" smooth>BOX MEALS</Link>
        <Link to="#BURGERS" smooth>BURGERS</Link>
        <Link to="#STAY_HOME_SPECIALS" smooth>STAY HOME SPECIALS</Link>
        <Link to="#SNACKS" smooth>SNACKS</Link>
        <Link to="#BEVERAGES" smooth>BEVERAGES</Link>
     </div>
